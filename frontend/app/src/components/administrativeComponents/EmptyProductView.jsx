...
export default function EmptyProductView({ onAddProduct }) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-4">
      <img className="w-60 h-60 mb-6"src='https://i.postimg.cc/2V2TScPC/Chat-GPT-Image-20-abr-2025-09-04-22-p-m.png' border='0' alt='Chat-GPT-Image-20-abr-2025-09-04-22-p-m'/>
